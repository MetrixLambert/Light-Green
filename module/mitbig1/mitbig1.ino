...
void loop(){
  ...
  unsigned long Value_CH3;
  unsigned long Value_CH4;
if((Value_CH3>1400)&&(Value_CH3<1600)){   //Stop
    ...
    else if(Value_CH3<1400){                  //Primer Grado Abajo
      digitalWrite(Grado_1_arriba,LOW);
      digitalWrite(Grado_1_abajo,HIGH);      
    }
    else if(Value_CH3>1600){                  //Primer Grado Arriba
